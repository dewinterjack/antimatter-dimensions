...
2. **Verify with Playwright skill** — resize to mobile (`430x932`), take screenshots, test interactivity
...
### Always verify with Playwright skill before committing

Use the `$playwright` skill browser automation to visually verify all changes. **Default to mobile dimensions** since most active work targets mobile.
